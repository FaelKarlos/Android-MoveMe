...
public class HttpServiceVeiculo extends AsyncTask<String, Void, Veiculo> {

    private String veiculo;
    private String operacao;

    //Construtor com um parâmetro, que nesse caso é o motorista a ser inserido
    public HttpServiceVeiculo(String veiculo, String operacao) {
        this.veiculo = veiculo;
        this.operacao = operacao;
    }

    public HttpServiceVeiculo() {

    }

    @Override
    protected Veiculo doInBackground(String... voids) {
        StringBuilder resposta = new StringBuilder();
        System.out.println("Operação passada por parametro: " + operacao);
        Gson gson = new Gson();

        //Converte o motorista passado para Json
        String jsonUsuario = gson.toJson(veiculo);

        Veiculo motoristaRetorno = gson.fromJson(veiculo, Veiculo.class);
        if (operacao.equals("inserir")){
            ...
            try {
                ...
                URL url = new URL("http://b8439639.ngrok.io/MoveMe/rest/veiculo/inserir");
        ...
        if(operacao.equals("login")){
            ...
            try {
                //Localização do web service
                String jsonUsuarioLogin = gson.toJson(veiculo);

                Veiculo motoristaLogin = gson.fromJson(veiculo, Veiculo.class);

                System.out.println("Usuario passado: " + motoristaLogin.toString());

                URL url = new URL("http://b8439639.ngrok.io/MoveMe/rest/veiculo/" + motoristaLogin.getId() + "/");
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                ...
                motoristaRetorno = gson.fromJson(str, Veiculo.class);
            } catch (MalformedURLException e) {
                e.printStackTrace();
            } catch (IOException e) {
                e.printStackTrace();
        ...
        if(operacao.equals("recuperarSenha")){
            ...
            try {
                ...
                Veiculo passageiroResetaSenha = gson.fromJson(veiculo, Veiculo.class);

                System.out.println("Usuario passado: " + passageiroResetaSenha.toString());

                URL url = new URL("http://b8439639.ngrok.io/MoveMe/rest/veiculo/resuperarsenha/" + passageiroResetaSenha.getId() + "/");
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                connection.setRequestMethod("GET");
        ...
        if(operacao.equals("editar")){
            ...
            try {
                ...
                URL url = new URL("http://b8439639.ngrok.io/MoveMe/rest/veiculo/editar");
