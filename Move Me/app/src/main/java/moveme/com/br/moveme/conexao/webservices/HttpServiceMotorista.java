    ...
    protected Motorista doInBackground(String... voids) {
        ...
        if(operacao.equals("login")){
            ...
            try {
                ...
                URL url = new URL("http://b8439639.ngrok.io/MoveMe/rest/motorista/" + motoristaLogin.getCpf() + "/");
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        ...
        if(operacao.equals("recuperarSenha")){
            ...
            try {
                ...
                Motorista motoristaResetaSenha = gson.fromJson(motorista, Motorista.class);

                System.out.println("Usuario passado: " + motoristaResetaSenha.toString());

                URL url = new URL("http://b8439639.ngrok.io/MoveMe/rest/motorista/resuperarsenha/" + motoristaResetaSenha.getEmail() + "/");
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                connection.setRequestMethod("GET");
