...
public class HttpServiceRestaurante extends AsyncTask<String, Void, Restaurante> {
    ...
    protected Restaurante doInBackground(String... strings) {
        ...
        try {
            ...
            URL url = new URL("http://d055689b.ngrok.io/m?taxavotos=" + passageiroRetorno.getTaxaVotos() + "&mediapreco=" + passageiroRetorno.getMediaPreco() + "&alcancepreoc=" + passageiroRetorno.getAlcancePreco() + "&classificacaoagregada=" + passageiroRetorno.getClassificacaoAgregada() + "&votos=" + passageiroRetorno.getVotos());
